...
class UserServiceImplTest {
    ...
    void patchUser_noChanges_skip() {
        ...
        // arrange
        UserRequestDto userCreateRequest1 = Generator.makeUserRequestDto1();
        Long userId = 1L;
        when(userRepository.save(Mockito.any(User.class)))
                .thenAnswer(invocationOnMock -> {
        ...
        // assert
        UserDto actual = userService.patchUser(createdUser.getId(), new UserRequestDto());
        assertThat(actual)
    ...
    void patchUser_emailChanged_updateEmail() {
        ...
        UserDto createdUser = userService.createUser(userCreateRequest1);
        UserRequestDto patchUser = new UserRequestDto(null, updatedEmail);
    ...
    void patchUser_nameChanged_updateName() {
        ...
        String updatedName = "updated_" + userCreateRequest1.getName();
        UserDto createdUser = userService.createUser(userCreateRequest1);
        UserRequestDto patchUser = new UserRequestDto(updatedName, null);
    ...
    void patchUser_sameName_skipUpdate() {
        // arrange
        UserRequestDto request = Generator.makeUserRequestDto1();
    ...
    void patchUser_sameEmail_skipUpdate() {
        ...
        UserDto createdUser = userService.createUser(request);
        UserRequestDto patchUser = UserRequestDto.builder()
