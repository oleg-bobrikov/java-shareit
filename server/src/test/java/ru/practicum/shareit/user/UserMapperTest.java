...
class UserMapperTest {
    ...
    UserRequestDto createTestUserRequestDto() {
    ...
    void shouldMapShortUserDtoToModel() {
        assertNull(mapper.toModel((UserRequestDto) null));

        UserRequestDto userShortDto = createTestUserRequestDto();
    ...
    void shouldMapUserShortDtoToDto() {
        assertNull(mapper.toDto((UserRequestDto) null));
