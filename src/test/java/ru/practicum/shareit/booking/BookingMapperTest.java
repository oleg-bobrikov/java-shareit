...
class BookingMapperTest {
    ...
    void toDto_bookingIsNotNull_returnDto() {
        ...
        assertThat(actual)
                ...
                .hasFieldOrPropertyWithValue("start", InstantConverter.toPattern(booking.getStartDate().toInstant()))
                .hasFieldOrPropertyWithValue("end", InstantConverter.toPattern(booking.getEndDate().toInstant()));
